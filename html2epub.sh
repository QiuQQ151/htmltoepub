...
# epub打包
# 选择封面图片
# largest_image=$(find "$DIR/temp/xhrb/epub/OEBPS/images/" -type f \( -iname "*.jpg" -o -iname "*.png" -o -iname "*.gif" \) -exec du -b {} + | sort -n | tail -n 1 | awk '{print $2}')
# cp "$largest_image" "$DIR/temp/xhrb/epub/OEBPS/cover.jpg"
#     # 特别的封面
#         # 定义目标日期
#         target_day=
#         target_month=
...
#             # 在这里执行你的特定命令
#             cp "$DIR/lib/birthday.jpg" "$DIR/temp/xhrb/epub/OEBPS/cover.jpg"
#         else
